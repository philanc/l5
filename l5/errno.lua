...
------------------------------------------------------------------------
-- errno constants and text messages
...
errno.msg_table = {
	...
	[45] = "EL -2NSYNC Level 2 not synchronized",
	[46] = "EL -3HLT Level 3 halted",
	[47] = "EL -3RST Level 3 reset",
	[48] = "ELNRNG - Link number out of range",
	[49] = "EUNATCH - Protocol driver not attached",
	[50] = "ENOCSI - No CSI structure available",
	[51] = "EL -2HLT Level 2 halted",
...
function errno.msg(eno) 
	return errno.msg_table[eno] or "Unknown errno value"
end
